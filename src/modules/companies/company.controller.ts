...
export async function updateSettings(req: FastifyRequest<{ Body: { monthlyFixedCost?: number; defaultTaxRate?: number; defaultCardFee?: number; desiredProfit?: number; targetProfitValue?: number; manualEmployeeCostEnabled?: boolean } }>, reply: FastifyReply) {
    try {
